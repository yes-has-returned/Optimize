...
class Player:
    def __init__(self, sprites):
        ...
        self.attack_cd = 0
        self.max_attack_cd = 15
        self.attack_duration = 0
        self.max_attack_duration = 10
        

    def move(self, keypress, jkeypress, dashpress, attackpress, friction=10):
        print(self.facing)
        ...
        if attackpress == True and self.attack_cd == 0:
            if self.facing == "left":
                ...
                self.attack_pos = (self.x2d - 16, self.y2d + 56)
        ...
        #wall jump
        if self.x2d < 0 and self.walljump == True:
            self.x2d = 0
            ...
            self.facing = "right"
        elif self.x2d > 1248 and self.walljump == True:
            self.x2d = 1248
            self.hormomentum = self.hormomentum*-1
            self.dash_dir *= -1
            self.vertmomentum = self.jumppower
...
while running:
    if testing_mode == "navigation":
        ...
        P.move(keypress, jkeypress, dashpress, attackpress)
